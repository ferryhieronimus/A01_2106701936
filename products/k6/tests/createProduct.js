...
const visitorsPerSecond = generateNPoissonWithSpike(120, 300);
...
export default function () {
  ...
  const payload = {
    ...
    description: `Product description created during load testing ${timestamp}`,
    price: Math.floor(Math.random() * 10000) + 1000,
    category_id: "36ca7bd1-14f4-4a9e-b259-70c05a011cbf",
    quantity_available: 999999999,
  };
