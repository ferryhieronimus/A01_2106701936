...
const visitorsPerSecond = generateNPoissonWithSpike(120, 30); // Reduced from 100 to a more realistic 10 RPS for cart endpoint
...
export default function () {
  ...
  const res = http.get("http://localhost:8001/api/cart", { headers });
